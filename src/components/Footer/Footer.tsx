...
const Footer = ({footerImg, footerNewsLetter}: FooterProps) => {
    return (
        ...
        <footer className={styles.footer}>
            <FooterContainer>
                {footerImg && 
                    <FooterImage footerImg={footerImg}/>
                }
                <FoooterLine />
                <FooterGroupRow>
                        <FooterGroup title = 'Company'>
                            ...
                            <FooterGroupItem href='/brandCenter' text='Brand Center'/>
                        ...
                        <FooterGroup title = 'Legal'>
                            <FooterGroupItem href='/privacyPolicy' text='Privacy Policy'/>
                            <FooterGroupItem href='/licensing' text='Licensing'/>
                            <FooterGroupItem href='/termsConditions' text='Terms & Conditions'/>
                        </FooterGroup>
                        <FooterGroup title = 'Contact Us'>
                            <FooterGroupItem text='+33678954367'/>
                            <FooterGroupItem text='ydesign@gmail.com'/>
                            <FooterGroupItem text='16 rue height valley Lyon 69009'/>
                        </FooterGroup>
                </FooterGroupRow>
                <FoooterLine />
                {footerNewsLetter &&
            ...
            <FooterBottom>
                <FooterCompany companyName="YDesign" companyCreationDate="2024" />
                <FooterIcons />
            </FooterBottom>        
        </footer>
    );
